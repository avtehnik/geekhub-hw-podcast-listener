...
//    }
//    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Player" withExtension:@"xcdatamodeld"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"tdfrtcf.sqlite"];
